...
public class Account {
	...
	// Bug fix - monthlyInterestRate has been changed respectively in different
	// types of
	// accounts. Making it static is affecting all objects due to its global nature
	// private static float monthlyInterestRate = 1.01f;
	private float monthlyInterestRate = 1.01f;

	// Bug fix - monthlyFee has been changed respectively in different types of
	// accounts. Making it static is affecting all objects due to its global nature
